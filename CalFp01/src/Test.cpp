...
void calcChangeTest()
{
	...
	int numCoins4 = 3;
	int coinValues4[numCoins4] = {2, 5, 6};
	ASSERT_EQUAL("5;2;", calcChange(7, numCoins4, coinValues4));
...
int main(int argc, char const *argv[]) {
	...
	cout << time << endl;
	 */
	cout << b_recursive(1) << endl;
	cout << b_dynamic(1) << endl;
	cout << b_recursive(2) << endl;
	cout << b_dynamic(2) << endl;
